<template>
    <div class="content">
        ...
        <h1 class="house-title" v-if="houseDetails">{{houseDetails.jibenxinxi.title}}</h1>        <!--顶部信息展示区域-->
