                ...
                <template slot="bottom">
                    <div class="mt-30 clearfix">
                        ...
                        <div class="type-arr clearfix">
                            <span v-for="item in selectedData"
                                  class="select-item" @click="handleReduce(item)">
                                {{item.title}}
        ...
        <div class="house-list" style="width: 1100px;margin: 80px auto;">
            ...
            <div class="data-list-wrap">
                <div class="order-box clearfix">
                    <label v-for="item in fillData.orderData"
                           class="order-label" :class="{active: params.order == item.id}">
                        {{item.title}}
